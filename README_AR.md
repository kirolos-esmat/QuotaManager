...
- **تغيير سيرفر VPN أو العميل يتم كشفه تلقائيًا** — عندما يظهر الاتصال الجديد
  بجوار القديم، تنتقل أجهزة المنزل إلى النفق الأحدث خلال دورة واحدة (~15
  ثانية)، فيخرج الجهاز والأجهزة دائمًا بنفس عنوان VPN. وإذا بدت الأجهزة عالقة
  على سيرفر قديم، اقلب مفتاح **مشاركة VPN** off ثم on — يمسح ذلك النفق
  المحفوظ ويجبر اكتشافًا جديدًا.
