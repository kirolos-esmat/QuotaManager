...
| **Admin** | security & credentials (change the dashboard password), **Software updates** (check for a newer release and install it from the dashboard), and **System Info & About** with **System Logs** (level filter, search, refresh, export) |
